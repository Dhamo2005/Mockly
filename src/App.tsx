    ...
    <div className="flex flex-col h-[100dvh] bg-[var(--color-surface)] overflow-hidden font-sans">
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <main className="flex-1 flex flex-col min-w-0 bg-[var(--color-surface-container)] md:rounded-tl-[32px] overflow-hidden shadow-inner relative">
          {!user && (
             <div className="absolute inset-0 bg-[var(--color-surface-container)]/95 backdrop-blur-sm z-40 flex flex-col items-center justify-center p-3 text-center">
                <div className="bg-white p-3 rounded-xl max-w-md w-full shadow-lg border border-gray-100 flex flex-col items-center">
                  <div className="w-16 h-16 bg-blue-50 rounded-full flex items-center justify-center mb-3">
                    <LogIn className="w-8 h-8 text-blue-600" />
                  </div>
                  <h2 className="text-base font-bold text-gray-900 mb-3">Sign in to Sync</h2>
                  <p className="text-gray-500 mb-4">Sign in with Google to load your tests and progress from Google Drive. Your data is securely synced to your personal Drive.</p>
                </div>
             </div>
          )}
          <div className="flex-1 google-main-stage p-3 sm:p-3 overflow-y-auto">
            {children}
          </div>
        </main>
      </div>
